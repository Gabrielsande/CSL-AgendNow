...
// Adiciona funcionalidade ao botão "Casa" para exibir todos os cards
const homeButton = document.querySelector('.home'); // Botão "Casa"
homeButton.addEventListener('click', () => {
  cards.forEach(card => card.style.display = 'block'); // Exibe todos os cards
  filtroTitulo.textContent = ''; // Limpa o título do filtro
});
